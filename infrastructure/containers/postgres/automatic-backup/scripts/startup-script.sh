...
echo "Running python3 -m xonsh backup_or_restore.py restore-from-most-recent"
python3 -m xonsh backup_or_restore.py restore-from-most-recent

# Backs up the database to S3 regularly according to the $BACKUP_INTERVAL
echo "Running python3 -m xonsh backup_or_restore.py backup-on-interval"
python3 -m xonsh backup_or_restore.py backup-on-interval
