...
def make_morphemes_json(
    complete_morphemes: List[CompleteMorpheme], morphemes_json_fpath: Union[Path, str]
) -> None:
    """Cache all of the queries morphemes in a JSON file on local disk."""
